...
def test_native_adapter_schema_readback_preserves_list_cardinality() -> None:
    ...
    from tests.support.google_adk import FakeGoogleADKSDK
    from tests.support.openai import FakeOpenAISDK
    from tests.support.strands import FakeStrandsSDK
...
def test_strands_materialization_rejects_native_tool_that_drops_list_bound(tmp_path: Path) -> None:
    ...
    from tests.support.strands import FakeStrandsSDK, write_project
